...
files = glob.glob(r"C:/Users/student/pythonProject6/hardデータ/image/*.jpg")

for i in files:
    img = imread(i)
    basename = os.path.splitext(os.path.basename(i))[0]
    mask = imread(r"C:/Users/student/pythonProject6/hardデータ/mask/" + basename + ".png")
    # mask = img
    ...
    imwrite(os.path.join("C:/Users/student/pythonProject6/前処理1/image", basename + ".png"), img)
    imwrite(os.path.join("C:/Users/student/pythonProject6/前処理1/mask", basename + ".png"), mask)
