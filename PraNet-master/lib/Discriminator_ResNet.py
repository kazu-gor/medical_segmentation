...
#         # self.cbr2_1 = BasicConv2drelu(1, 1, 1)
#         # self.cbr2_2 = BasicConv2drelu(3, 1, 1)
...
#
#         self.l1 = nn.Linear(in_features=16384, out_features=2, bias=False)
...
#
#         self.av1 = nn.AdaptiveAvgPool2d((8, 8))
#
#     def forward(self, x):
#         # x = x * z
#         # x = self.cbr2_1(x)
