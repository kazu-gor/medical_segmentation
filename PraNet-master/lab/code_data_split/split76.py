...
files4 = glob.glob(
    r"/home/student/src2/藤林/プログラム/PraNet-master/lab/nana_roku/test3_mask/*.png"
)
...
files5 = glob.glob(
    r"/home/student/src2/藤林/プログラム/PraNet-master/lab/nana_roku/train_mask/*.png"
)
for i in files5:
    img = imread(i)
    imwrite(
...
files6 = glob.glob(
    r"/home/student/src2/藤林/プログラム/PraNet-master/lab/nana_roku/val_mask/*.png"
)
for i in files6:
    img = imread(i)
    imwrite(
