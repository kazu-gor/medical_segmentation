...
with open(
    "/home/student/src2/藤林/プログラム/PraNet-master/lab/ssd_txt/train.txt",
    "w",
    encoding="utf-8",
) as f:
    for i in files1:
...
with open(
    "/home/student/src2/藤林/プログラム/PraNet-master/lab/ssd_txt/val.txt",
    "w",
    encoding="utf-8",
) as f:
    for i in files2:
...
with open(
    "/home/student/src2/藤林/プログラム/PraNet-master/lab/ssd_txt/test3.txt",
    "w",
    encoding="utf-8",
) as f:
    for i in files3:
...
with open(
    "/home/student/src2/藤林/プログラム/PraNet-master/lab/ssd_txt/test7.txt",
    "w",
    encoding="utf-8",
) as f:
    for i in files4:
...
with open(
    "/home/student/src2/藤林/プログラム/PraNet-master/lab/ssd_txt/test.txt",
    "w",
    encoding="utf-8",
) as f:
    for i in files5:
