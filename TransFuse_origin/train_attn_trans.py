...
if __name__ == '__main__':
    ...
    # parser.add_argument('--train_path', type=str, default='./dataset/dataset_v2/sekkai/sekkai_TrainDataset', help='path to train dataset')
    # parser.add_argument('--val_path', type=str, default='./dataset/dataset_v2/sekkai/sekkai_ValDataset', help='path to val dataset')
    ...
    fig.savefig("fig/AttnTransFuse_loss.png")
