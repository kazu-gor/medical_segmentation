...
parser.add_argument('--test_path', type=str,
                    default='./dataset/TestDataset/', help='path to test dataset')
parser.add_argument('--normalization', type=bool, default=False)

opt = parser.parse_args()

# data_path = './dataset/sekkai_TestDataset/'
data_path = './dataset/crop_TestDataset'
norm = opt.normalization
save_path = './results/YOLO_TransCaraNet/'

model = Trans_CaraNet_L()
model.load_state_dict(torch.load(
    './snapshots/Transfuse_S/Transfuse-best.pth'))
# model.load_state_dict(torch.load(
