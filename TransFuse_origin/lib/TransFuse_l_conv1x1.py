...
from timm.models.layers import (DropPath, set_layer_config, to_2tuple,
                                trunc_normal_)
...
class TransFuse_L(nn.Module):
    def __init__(
        ...
        ##########  Upsample -> Sigmoid -> Conv1x1  ##########
        self.conv1x1 = nn.Conv2d(3, 3, kernel_size=1, padding=0).cuda()
        ######################################################
    ...
    def forward(self, imgs, labels=None):
        ...
        # dis_in = self.conv1x1(dis_in.sigmoid().repeat(1, 3, 1, 1))
