...
# =====================================================================
# Original TransFuse MTL
# =====================================================================

# save_path="TransFuse_nash"

# echo ">>> train and test original transfuse mtl"
# python3 ./train_trans_nash.py --train_save ${save_path} \
#     1> >(tee ./logs/train_trans_nash_stdout.log >&1 ) 2> >(tee ./logs/train_trans_nash_stderr.log >&2)
# python3 ../../tools/slack_bot.py --text "`cat ./logs/train_trans_nash_stdout.log`"
# python3 ../../tools/slack_bot.py --text "`cat ./logs/train_trans_nash_stderr.log`"
...
#     1> >(tee ./logs/test_trans_nash_stdout.log >&1 ) 2> >(tee ./logs/test_trans_nash_stderr.log >&2)
# python3 ../../tools/slack_bot.py --text "`cat ./logs/test_trans_nash_stdout.log`"
# python3 ../../tools/slack_bot.py --text "`cat ./logs/testtrans_nash_stderr.log`"
...
# =====================================================================
# Original TransCaraNet MTL
# =====================================================================

save_path="TransCaraNet_nash"

echo ">>> train and test original transfuse mtl"
python3 ./train_trans_caranet_nash.py --train_save ${save_path} \
    1> >(tee ./logs/train_trans_caranet_nash_stdout.log >&1 ) 2> >(tee ./logs/train_trans_caranet_nash_stderr.log >&2)
python3 ../../tools/slack_bot.py --text "`cat ./logs/train_trans_caranet_nash_stdout.log`"
python3 ../../tools/slack_bot.py --text "`cat ./logs/train_trans_caranet_nash_stderr.log`"
...
python3 ./test_trans_caranet_nash.py --pth_path "./snapshots/${save_path}/Transfuse-best.pth" --pth_path2 "./snapshots/${save_path}/Discriminator-best.pth" \
    1> >(tee ./logs/test_trans_caranet_nash_stdout.log >&1 ) 2> >(tee ./logs/test_trans_caranet_nash_stderr.log >&2)
python3 ../../tools/slack_bot.py --text "`cat ./logs/test_trans_caranet_nash_stdout.log`"
python3 ../../tools/slack_bot.py --text "`cat ./logs/testtrans_caranet_nash_stderr.log`"
