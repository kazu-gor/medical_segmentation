...
if __name__ == "__main__":
    ...
    checkpoint = torch.load("./snapshots/TransFuse_nash_mtl_b8/Transfuse-99.pth")
    checkpoint = {
        k.replace("Resnet.", ""): v for k, v in checkpoint.items() if "Resnet" in k
    }
    ...
    for epoch in range(1, opt.epoch):
        ...
        epoch, train_d_loss, val_d_loss, best_loss, best2_loss = train(
            dataloaders_dict, models, optimizer, criterion, epoch, best_loss, best2_loss
        )
        end_time = time.time()
